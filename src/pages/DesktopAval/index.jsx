    ...
    <>
      <div className="bg-gray-900 flex flex-col font-rubik items-center justify-end mx-auto p-[30px] sm:px-5 w-full">
        <div className="flex flex-col justify-start max-w-[1222px] mt-[13px] mx-auto md:px-5 w-full">
          ...
          <Text
            className="ml-10 md:ml-[0] mt-[61px] relative right-[1.5rem] md:text-3xl sm:text-[28px] text-[32px] text-center text-white-A700"
            size="txtRubikRomanSemiBold32"
          >
            Possui cartão de crédito?
          </Text>
          <div className="flex flex-row md:gap-0.5 gap-[54px] items-center justify-center md:left-[4rem] md:ml-[0] ml-[441px] mt-[149px] md:relative md:w-4/5 w-[28%] sm:w-full">
            <div className="flex flex-col items-center justify-start w-[43%]">
              <Button
                ...
                onClick={() => navigate("/desktopavalthree")}
                shape="round"
                color="gray_700"
                size="lg"
                variant="outline"
...
export default DesktopAvalPage;
